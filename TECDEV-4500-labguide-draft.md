...
# 2 Playbook primer
- Playbook exercises involve creating playbook files.
...
## 1.12 Ansible Vault
- This topic can be skipped. Automation exercises do not depend on valut.
...
- We will go over the following exercises:
...
- The optional exercises at the end of this section addresses the above tow problems and enhance this playbook. Feel free to follow the optional playbook if you want to review the other playbook.
- Review the section and discuss if you have any questions.
...
- Important: If there is ospf config, **delete** it for this exercises.
- Run the playbook"
...
- Just for example, installation steps for CentOS:
	- `$ sudo yum update`
...
## Optional exercise oe-21
## Optional exercise oe-22
## Optional exercise o-23
